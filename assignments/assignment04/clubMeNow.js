...
function undoLastShot(str) {
	...
	//localStorage.setItem("clubs2", str2);
	//clubs2 = JSON.parse(localStorage.getItem("str2"));
	//clubs2 = JSON.parse(localStorage.getItem("str"));
	// and refresh screen
	...
	let str2 = str;
	localStorage.setItem("clubsOld", str2);
	let lastValue = localStorage.getItem("clubsOld");
	//let clubs2 = JSON.parse(str2);
...
function updateStats(shotDistance=0) {
	...
	if(parseInt(shotDistance) > 0) {
		...
		localStorage.setItem("clubs", str);
		localStoreae.setItem("clubsOld",str); // old clubs
